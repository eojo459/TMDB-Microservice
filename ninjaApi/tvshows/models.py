...
class TVShows(models.Model):
    ...
    actors_cast = models.ManyToManyField(Peoples, related_name='tv_actor') # FK to actors
    director = models.ManyToManyField(Peoples, related_name='tv_director') # FK to actors
