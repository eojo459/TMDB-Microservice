    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('actors_cast', models.ManyToManyField(related_name='movie_actors', to='people.peoples')),
                ('director', models.ManyToManyField(related_name='movie_director', to='people.peoples')),
